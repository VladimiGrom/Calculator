...
public class Calculator {
    ...
    public static String calc(String input) throws Exception {
        ...
        String[] operands = input.split("[+\\-*/]");// находим действие +, -, *, /,
        if (operands.length != 2) throw new Exception("Дожно быть два числа");// проверяем что были ввендены два числа

        oper = detectOperation(input);
        if (oper == null) throw new Exception("Неподдерживаемая математическая операция");

        // проверяем что оба числа римские
        ...
        // проверяем что числа соответствуют условию
        if (num1 > 10 || num2 > 10) {
    ...
    // метод для определения математической операции
    ...
    // метод для вычесления с учетом оператора
...
// класс для проверки и перевода в римские числа и обратно
class Roman {
    ...
    //метод для проверки введеных чисел
